...
public class ventas extends javax.swing.JFrame {
    ...
    public void refresh() {
        ...
        jLabelIdVenta.setText("Id: " + VentaSQL.getIdVenta());
        jLabelFecha.setText("Fecha: " + cv.fecha());
        jLabelTotal.setText("Total: " + cv.total);
    }
    ...
    private void initComponents() {
        ...
        jTextFieldCliente.setText("Ingrese el nombre del cliente");
        ...
        jTextFieldProducto.setText("Ingrese el nombre del producto");
        ...
        jTextFieldCantidad.setText("Ingrese la cantidad del producto");
    ...
    private void btt_inicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btt_inicioActionPerformed
        ...
        DefaultTableModel aux = cv.agregarProducto(Integer.parseInt(jTextFieldCliente.getText()), Integer.parseInt(jTextFieldProducto.getText()), Integer.parseInt(jTextFieldCantidad.getText()), jTableModel);
        if (aux != null) {
            jTableModel = aux;
        }
    ...
    private void btt_inicio2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btt_inicio2ActionPerformed
        // TODO add your handling code here:
        if (cv.listaVentas.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe ingresar al menos un producto!");
            return;
        }
        cv.realizarVenta(new Venta(VentaSQL.getIdVenta(), Integer.parseInt(jTextFieldCliente.getText()), Date.valueOf(LocalDate.now()), cv.total*0.88f, cv.total, 0, 1));
